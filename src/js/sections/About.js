...
const About = () => {
  ...
  return (
    <section ref={ref_about} id="about" className="section section--about" data-scroll-section>
      <div className="section-width section-width--padding">
        <div className="animate__animated animate__delay-1ms" data-scroll data-scroll-repeat="false" data-scroll-class="animate__slideInUp">
